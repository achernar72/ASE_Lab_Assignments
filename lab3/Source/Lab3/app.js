        ...
        $scope.getVenues = function () {
            ...
            if (placeEntered != null && placeEntered != "" && searchQuery != null && searchQuery != "") {
                ...
                var handler = $http.get("https://api.foursquare.com/v2/venues/search" +
                    "?client_id=WYYOHFP0EN5GN11S24DZTUVWUBSQK5XW3MMTDPNLDBBGMZLT" +
                    "&client_secret=LIGIOVV1O2ZD3TLQX4B3VFTO4RT1KDR4U1J42RR2MK4LMJMB" +
                    "&v=20160215&limit=5" +
                    "&near=" + placeEntered +
                    "&query=" + searchQuery);
                    ...
                    if (data != null && data.response != null && data.response.venues != undefined && data.response.venues != null) {
                        for (var i = 0; i < data.response.venues.length; i++) {
                            $scope.venueList[i] = {
                                ...
                                "city":data.response.venues[i].city,
        ...
        $scope.getReviews = function (venueSelected) {
            if (venueSelected != null) {
                ...
                var handler = $http.get("https://api.foursquare.com/v2/venues/" + venueSelected.id + "/tips" +
                    "?sort=recent" +
                    "&client_id=WYYOHFP0EN5GN11S24DZTUVWUBSQK5XW3MMTDPNLDBBGMZLT" +
                    "&client_secret=LIGIOVV1O2ZD3TLQX4B3VFTO4RT1KDR4U1J42RR2MK4LMJMB&v=20160215" +
                    "&limit=5");
